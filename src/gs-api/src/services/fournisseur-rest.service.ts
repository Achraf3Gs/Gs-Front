...
import { delete2 } from '../fn/fournisseur-rest/delete-2';
import { Delete2$Params } from '../fn/fournisseur-rest/delete-2';
import { findAll2 } from '../fn/fournisseur-rest/find-all-2';
import { FindAll2$Params } from '../fn/fournisseur-rest/find-all-2';
import { findById2 } from '../fn/fournisseur-rest/find-by-id-2';
import { FindById2$Params } from '../fn/fournisseur-rest/find-by-id-2';
import { FournisseurDto } from '../models/fournisseur-dto';
import { save2 } from '../fn/fournisseur-rest/save-2';
import { Save2$Params } from '../fn/fournisseur-rest/save-2';

@Injectable({ providedIn: 'root' })
export class FournisseurRestService extends BaseService {
